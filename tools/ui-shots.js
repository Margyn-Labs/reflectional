...
const VIEWS = ['home','inbox','cash','cfopack','payments','receivables','payables','gst','books','invoicing','customers','vendors','analytics','scores','history','agents','connectors','people','settings','audit','financing','profile','calculate','ledger'];
